...
public final class TaskHandle {
   ...
   * @param payLoad          the primary payload blob handle for this task
  ...
  /**
   * Returns the primary payload blob handle for this task.
   * <p>
   * The payload represents the main executable content or data that defines what
   * the task should process. This is typically the primary input that drives
   * task execution, separate from auxiliary input data.
   *
   * @return the payload blob handle
   * @see BlobHandle
   */
